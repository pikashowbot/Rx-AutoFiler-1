...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a>,【ɪᴀᴍ ʟᴀᴛᴇꜱᴛ ᴀᴅᴠᴀɴᴄᴇᴅ】ᴀɴᴅ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ+└𝗣𝗶𝗸𝗮𝘀𝗵𝗼𝘄 𝟭.𝟬┘+├ꜰɪʟᴇ ꜱᴛᴏʀᴇ ʙᴏᴛ┤+☞ᴍᴀɴᴜᴀʟ ꜰɪᴛᴇʀ☜ ᴀɴᴅ ᢵᴄᴜꜱᴛᴏᴍɪᴢᴇᴅ ꜱʜᴏʀᴛɴᴇʀ ꜱᴜᴘᴘᴏʀᴛᢴ ᢾᴀɴᴅ ʙᴇꜱᴛ ᴜɪ ᴘᴇʀꜰᴏʀᴍᴀɴᴄᴇᢿ</b>"""
...
➣  Must Take a Screenshot after Payment and Send it to @spshah878 To Activate Your Subscription</b>"""
    
    QR_TXT = """<b>👋 ʜᴇʏ {},
    
⚜️ ᴘᴀʏ ᴀᴍᴍᴏᴜɴᴛ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ᴘʟᴀɴ ᴀɴᴅ ᴇɴᴊᴏʏ ᴘʀᴇᴍɪᴜᴍ ᴍᴇᴍʙᴇʀꜱʜɪᴘ !

📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://graph.org/file/42addd2d97784d0f9c9a6.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>
...
👉 <b>Payment methods:</b>
  ...
  ➣  UPI ID :  shah.910@paytm
  📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://graph.org/file/42addd2d97784d0f9c9a6.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>
    ➣  Must Take a Screenshot after Payment and Send it to @spshah878 To Activate Your Subscription 

⚜️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan

👉  <b>Refferal offer :-</b>
      If any user takes a premium subscription from you, you will be given a cash reward of 30% of that subscription amount immediately.  
Note:- This offer will be applicable only on premium subscription of 1 month and above.""" 
...
‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ʟɪsᴛ.</b>"""
    ...
    SUBSCRIPTION_TXT = """<b>🔰<u> आप 3 तरह से प्रीमियम सब्सक्रिप्शन ले सकते हैं।</u></b>

<b>1) 20 लोगो को यह बोट, अपने रेफरल लिंक्स से ज्वॉइन करवा कर।</b> <i>(1 महीने की वैलिडिटी)</i>
<b>2) बोट में लॉगइन करके।</b> <i>(साइनआउट करने तक की वैलिडिटी)</i> 👉<b> /login </b>
<b>3) प्रीमियम प्लान खरीद कर।</b> <i>(प्लान वैलिडिटी)</i> 👉<b> /plan </b>

<b>🔰<u> Yᴏᴜ Cᴀɴ Gᴇᴛ Pʀᴇᴍɪᴜᴍ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ Iɴ 𝟹 Wᴀʏs</u></b>

<b>𝟷) Bʏ Gᴇᴛᴛɪɴɢ 𝟸𝟶 Pᴇᴏᴘʟᴇ Tᴏ Jᴏɪɴ Tʜɪs Bᴏᴛ Tʜʀᴏᴜɢʜ Yᴏᴜʀ Rᴇғᴇʀʀᴀʟ Lɪɴᴋs.</b> <i>(𝟷 Months Validity)</i>
<b>𝟸) Bʏ Lᴏɢɪɴ Iɴ Tᴏ Tʜᴇ Bᴏᴛ.</b> <i>(Validity Until You Don't SignOut)</i> 👉<b> /login </b>
<b>𝟹) Bʏ Pᴜʀᴄʜᴀsɪɴɢ Pʀᴇᴍɪᴜᴍ Pʟᴀɴ.</b> <i>(Plan Validity)</i> 👉<b> /plan </b>

<b>🔰<u> Yᴏᴜʀ Rᴇғғᴇʀᴀʟ Lɪɴᴋ</u> 👉 https://telegram.me/{}?start=VJ-{}</b>"""
...
• ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/spshah878'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
