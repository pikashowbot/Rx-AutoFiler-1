...
second_auth_channel = environ.get('SECOND_AUTH_CHANNEL', '-1002319033437')  # Add the second auth channel or Group (should private)
third_auth_channel = environ.get('THIRD_AUTH_CHANNEL', '-1002344874561')  # Add the third auth channel or Group (should private)
...
URL = environ.get("URL", "https://vegamovies4u.xyz")  #if heroku then paste the app link here ex: https://heroku......./
# if len(URL) == 0:
